...
\begin{figure}[h]
  \begin{minipage}[h]{.50\textwidth}
To choose the best value of \textit{min-pts} now we can fix \textit{epsilon} to $0.05$ and plot, for every \textit{min-pts} in range $[2, 50]$, the silhouette coefficient 
  \end{minipage}
